...
;; Due to the same reasoning as in the exercise 2.14, the answer is "yes"
;; parallel-2 avoids unnecessary uncertainty 
;; by avoiding using the same variables more than once
